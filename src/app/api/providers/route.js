...
export async function POST(request) {
  try {
    ...
    // Compatible/embedding nodes support multiple connections for fallback/load-balancing.
    // The 1-connection limit was overly restrictive and prevented users from adding
    // additional API keys to the same node. auth.js already supports multi-connection
    // strategies (fill-first, round-robin) per provider.
